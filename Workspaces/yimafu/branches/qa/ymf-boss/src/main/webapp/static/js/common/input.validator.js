...
/*
 * if(action == "delete") { MessageBoxExt.ajax({ url :
 * $("#passwordDialogViewForm").attr(actionUrl+"?password="+password), data :
 * $("#passwordDialogViewForm").serialize(), style : "redirect" });
 * $("#passwordDialogViewForm").attr("action",actionUrl+"?password="+password); }
 * else if(action == "activate") {
 * $("#passwordDialogViewForm").attr("action",actionUrl+"?password="+password);
 * MessageBoxExt.ajax({ url :
 * $("#passwordDialogViewForm").attr(actionUrl+"?password="+password), data :
 * $("#passwordDialogViewForm").serialize(), style : "redirect" }); } else
 * if(action == "freeze") {
 * $("#passwordDialogViewForm").attr("action",actionUrl+"?password="+password);
 * MessageBoxExt.ajax({ url :
 * $("#passwordDialogViewForm").attr(actionUrl+"?password="+password), data :
