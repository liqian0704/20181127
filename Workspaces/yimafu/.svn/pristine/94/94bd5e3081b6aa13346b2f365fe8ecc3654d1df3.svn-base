...
public class BusinessArgs implements Serializable {
    private Long id;

    private Long optimisitc;
    @NotEmpty("业务方标识")
    @LengthValidator(value="业务方标识",length=50)
    ...
    @NotEmpty("业务方")
    @LengthValidator(value="业务方",length=50)
    ...
    public boolean equals(Object that) {
        ...
        BusinessArgs other = (BusinessArgs) that;
