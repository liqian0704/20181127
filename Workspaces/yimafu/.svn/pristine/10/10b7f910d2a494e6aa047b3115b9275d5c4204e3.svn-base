...
import com.yeepay.g3.core.ymf.entity.order.CsprocessCallbackParam;
...
//				throw new Exception("交易回调未返回，需等待交易回调成功后入账。") ;
	...
	public static void main(String args[]) {
		// CsprocessCallbackParam param = new CsprocessCallbackParam();
		for (Field field : CsprocessCallbackParam.class.getDeclaredFields()) {
