...
(
  ...
  PERCENT             DECIMAL(5,4),--存量商户计算比例,只有收款宝有
...
CREATE INDEX YMF_PROFIT_PROFIT_PRODUCT_TYPE_index ON YMF_PROFIT (PROFIT_PRODUCT_TYPE);
CREATE INDEX YMF_PROFIT_CUSTOMER_TYPE_index ON YMF_PROFIT (CUSTOMER_TYPE);
---SEQ
...
CREATE INDEX YMF_PROFIT_SUMMATION_PROFIT_PRODUCT_TYPE_index ON YMF_PROFIT_SUMMATION (PROFIT_PRODUCT_TYPE);
CREATE INDEX YMF_PROFIT_SUMMATION_CUSTOMER_TYPE_index ON YMF_PROFIT_SUMMATION (CUSTOMER_TYPE);
---SEQ
