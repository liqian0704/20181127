...
public class Customer implements Serializable {
    ...
    private TradeSystemEnum tradeSystem;
    ...
    public CustomerFlag getCustomerFlag() {
        return customerFlag;
    }

    public void setCustomerFlag(CustomerFlag customerFlag) {
        this.customerFlag = customerFlag;
    }

    public TradeSystemEnum getTradeSystem() {
        return tradeSystem;
    }

    public void setTradeSystem(TradeSystemEnum tradeSystem) {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getTradeSystem() == null ? other.getTradeSystem() == null : this.getTradeSystem().equals(other.getTradeSystem()))
            && (this.getBalanceProduct() == null ? other.getBalanceProduct() == null : this.getBalanceProduct().equals(other.getBalanceProduct()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTradeSystem() == null) ? 0 : getTradeSystem().hashCode());
        result = prime * result + ((getBalanceProduct() == null) ? 0 : getBalanceProduct().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", tradeSystem=").append(tradeSystem);
        sb.append(", balanceProduct=").append(balanceProduct);
