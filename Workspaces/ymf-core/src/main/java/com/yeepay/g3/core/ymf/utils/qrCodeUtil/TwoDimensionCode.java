...
import com.yeepay.g3.core.ymf.utils.common.ConvertUtils;
 ...
 * @CreateTime 2015-1-30 下午2:13:19
 * @version 1.0
 */
...
//		encodeAndDecode();
	...
	public String decodeImageHexStr(String imgHexStr ){
		byte[] bytes = ConvertUtils.hex2byte(imgHexStr);
		InputStream in = new ByteArrayInputStream(bytes);
		String url = this.decoderQRCode(in);
