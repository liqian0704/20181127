...
/**
 * @description: 认证费用存量商户计算
 * @author: xiaobin.liu
 * @date: 17/12/21
 * @time: 下午4:02
 */
@Service("authStockCalculator")
public class AuthStockCalculatorImpl extends AbstractProfitCalculator implements ProfitCalculator {
     ...
     * 存量商户，蜜糖毛利分配比例：5:5
     */
    protected static BigDecimal AUTH_STOCK_PROFIT_PERCENT = new BigDecimal(0.5).setScale(4, BigDecimal.ROUND_HALF_UP);
    ...
    protected BigDecimal getPercent() {
        return AUTH_STOCK_PROFIT_PERCENT;
    }
