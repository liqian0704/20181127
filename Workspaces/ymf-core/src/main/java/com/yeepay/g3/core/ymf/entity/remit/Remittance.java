...
public class Remittance implements Serializable {
    ...
    public Integer getRemitCount() {
        return remitCount;
    }

    public void setRemitCount(Integer remitCount) {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getRemitRequestTime() == null ? other.getRemitRequestTime() == null : this.getRemitRequestTime().equals(other.getRemitRequestTime()))
            && (this.getRemitCount() == null ? other.getRemitCount() == null : this.getRemitCount().equals(other.getRemitCount()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getRemitRequestTime() == null) ? 0 : getRemitRequestTime().hashCode());
        result = prime * result + ((getRemitCount() == null) ? 0 : getRemitCount().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", remitRequestTime=").append(remitRequestTime);
        sb.append(", remitCount=").append(remitCount);
