...
/**
 * Description: http工具类，【禁止】在业务中直接调用，必须走RemoteFacadeFactory
 * Author: wei.li
 * Date: 17/4/24
 * Version: 1.0
...
public class HttpUtils {
	...
	public static String post(String host, String path, Map<String, String> headers,
							  Map<String, String> querys, Map<String, String> bodys) throws Exception {
		return toString(doPost(host, path, headers, querys, bodys));
	}
