    ...
    <div style="margin-left: 10px;margin-top: 20px;">
        <table border="1" style="width:98%">
            ...
            <tr>
                ...
                <td width="24%">
                    <label class="text_tit" >结算方式</label>
                </td>
                <td width="24%">
                    <label class="text_tit"><e:write type="com.yeepay.g3.facade.ymf.enumtype.trade.BalanceType"
                                                     name="${customer.balanceProduct}"></e:write></label>
                </td>
            </tr>
            <tr>
                <td width="24%">
                ...
                <td width="24%">
                    <label class="text_tit"> ${customer.shortName}</label>
                </td>
                <td width="24%">
