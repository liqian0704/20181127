 ...
 * @time: 下午4:02
 */
@Service("likerStockCalculator")
public class LikerStockCalculatorImpl extends AbstractProfitCalculator implements ProfitCalculator {
     ...
     * 存量商户，蜜糖毛利分配比例：50%
     */
    protected static BigDecimal LIKER_STOCK_PROFIT_PERCENT = new BigDecimal(0.5).setScale(4, BigDecimal.ROUND_HALF_UP);
    ...
    protected BigDecimal getPercent() {
        return LIKER_STOCK_PROFIT_PERCENT;
    }
