...
//    {"110000":"北京 ","120000":"天津 ","130000":"河北 ","140000":"山西 ","150000":"内蒙古","210000":"辽宁 ","220000":"吉林 ","230000":"黑龙江","310000":"上海 ","320000":"江苏 ","330000":"浙江 ","340000":"安徽 ","350000":"福建 ","360000":"江西 ","370000":"山东 ","410000":"河南 ","420000":"湖北 ","430000":"湖南 ","440000":"广东 ","450000":"广西 ","460000":"海南 ","500000":"重庆 ","510000":"四川 ","520000":"贵州 ","530000":"云南 ","540000":"西藏 ","610000":"陕西 ","620000":"甘肃 ","630000":"青海 ","640000":"宁夏 ","650000":"新疆"}
    ...
    @ResponseBody
    public ResponseMessage addShop(Shop shop,int qrNo, HttpSession session) {
        logger.info("toAdd params:{}",shop);
        try {
            if (qrNo > 100) {
                return ResponseMessage.error("最多只能一次生成100张二维码。");
            }
            ResponseMessage resp = null;
            String user = this.getUser(session);
            shop.setCreateUser(user);//记录创建人员

            String customerNumber = shop.getCustomerNumber();
            Customer customer = customerService.findByCustomerNumber(customerNumber);

            List<QRCode> qrCodeList = shopBiz.batchBuildQrcode(qrNo, customer);
    ...
    public void downloadBatchShopResponse(@RequestParam String name, HttpServletResponse response) {
        try {
            String fileName = new String("网点批量创建模板.xlsx".getBytes("utf-8"),
                    "ISO8859-1");
            //String fileName = URLEncoder.encode("网点批量创建模板.xlsx", "UTF-8");//safari 火狐出现乱码
