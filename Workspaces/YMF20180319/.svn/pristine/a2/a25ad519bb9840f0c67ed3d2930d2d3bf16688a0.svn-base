...
public class AnnotationContextAwareTest extends SpringPrintTest {
    ...
    protected static final String INNER_ADDRESS = "http://106.120.186.94:8080/ymf-hessian/";
     ...
     * @return
     */
    protected <T> T getInnerFacade(Class<T> serviceClass) {
        return getRemoteService(INNER_ADDRESS, serviceClass);
    }
     ...
     * @return
     */
    protected <T> T getLocalFacade(Class<T> serviceClass) {
        return getRemoteService("http://localhost:8080/ymf-hessian/", serviceClass);
    }
     ...
     * @return
     */
    protected <T> T getRemoteService(String URL,Class<T> serviceClass) {
        T service = RemoteServiceFactory.getService(URL,
                RemotingProtocol.HESSIAN,serviceClass);
        return service;
    }
