                            ...
                            <ul >
                                <li>
                                    <p>
                                        ...
                                        <input type="text" class="input_text" id="value"  name="value" value="${param.value}"/>
                                    </p>
                                </li>
                            </ul>
                            <ul >
                            ...
                            <ul >
                                <li>
                                    <p>
                                        ...
                                        <input type="radio" name="canDelete" value="1" checked="checked"/>&nbsp;&nbsp;能
                                        <input type="radio" name="canDelete" value="0"/>&nbsp;&nbsp;不能
                                    </p>
                                </li>
                            </ul>
                            <div class="btn">
