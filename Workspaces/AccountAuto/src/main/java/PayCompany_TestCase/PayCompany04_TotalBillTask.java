...
@Test
    ...
    String billStartDate= BusinessUtil.getBillStartDate("1042781335",CommPro.payCompayBill);
    //定义账单号结束时间
    ...
    System.out.println("输出账单截至时间" + BusinessUtil.getBillEndDate("1042781335", CommPro.payCompayBill));
    billNoEndDate = sdf.parse(BusinessUtil.getBillEndDate("1042781335", CommPro.payCompayBill));
