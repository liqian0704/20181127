    ...
    <div style="margin-left: 10px;margin-top: 20px;">
        <table border="1" style="width:98%">
            ...
            <tr>
                ...
                <td width="24%">
                    <label class="text" style="font-size: 16px;">二维码id</label>
                </td>
                <td width="24%">
                    <label class="text"> ${order.sanCode} </label>
                </td>
            </tr>
            <tr>
                <td width="24%">
                    <label class="text" style="font-size: 16px;">入账状态</label>
                </td>
                <td width="24%">
                    <label class="text">  </label>
                    <e:write type="com.yeepay.g3.facade.ymf.enumtype.trade.SettleStatus" name="${payment.settleStatus}"/>
                </td>
                <td width="24%">
                    <label class="text" style="font-size: 16px;">入账时间</label>
                </td>
                <td width="24%">
                    <label class="text"> <fmt:formatDate value="${payment.settleTime}" pattern="yyyy-MM-dd HH:mm:ss"/> </label>
                </td>
            </tr>
