...
public class InVokeRemoteRemitServiceTest extends SoaContextAwareTest {
    ...
    public void doRemit(){
        ...
        param.setCustomerNumber("10040003895"); // 商户编号
        param.setGroupNumber("10040003895"); // 集团商户编号(非集团版本与商户编号填写一致就可以)
    ...
    public void queryRemitInfo() throws ParseException {
        ...
        queryParam.setCustomerId(40041223l);  //商户ID
        queryParam.setProduct("RJT");  //产品类型  RJT 日结通  WTJS 委托结算
        queryParam.setCreateDateStart(sf3.parse("2017-05-25 00:00:00"));
        queryParam.setCreateDateEnd(sf3.parse("2017-05-25 23:41:52"));
...
//        hessianx://172.22.2.4:8088/laike-hessian/soa/hessian/com.yeepay.g3.facade.laike.facade.ProductInfoFacade
    ...
    public void queryRemitInfoFromRemote(){
        ...
        RemitInfoQueryFacade remitInfoQueryFacade = getBean(RemitInfoQueryFacade.class);
