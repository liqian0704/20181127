...
import com.yeepay.g3.core.ymf.dao.customer.CustomerFunctionDao;
...
public class CustomerFunctionServiceImpl implements CustomerFunctionService{
    ...
    @Override
    public List<CustomerFunction> getByCustomerAndDicType(String customer, String dicType) {

        return customerFunctionDao.getByCustomerAndDicType(customer,dicType);
    }

    @Override
    public int batchCreate(List<CustomerFunction> list) {

        return customerFunctionDao.batchCreate(list);
    }
