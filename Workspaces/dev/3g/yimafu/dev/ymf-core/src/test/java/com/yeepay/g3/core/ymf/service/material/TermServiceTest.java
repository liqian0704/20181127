...
public class TermServiceTest extends BaseAnnotationContextAwareTest {
    ...
    @Test
    public void validateBindTerm() throws Exception {
        deepPrint(termService.validateBindTerm("10040040137", "LK0"));
        deepPrint(termService.validateBindTerm("10040040137", "sdfsdf"));
    }
