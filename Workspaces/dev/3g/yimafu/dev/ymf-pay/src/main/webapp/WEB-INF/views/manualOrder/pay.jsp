...
function doPay(){
	...
	var customerRequestId = $.trim($("#customerRequestId").val());
	if (customerRequestId == '') {
		Tools.alert("请输入订单号");
		return false ;
	}
	if (customerRequestId.length > 50) {
		Tools.alert("订单号长度不能超过50位");
		return false ;
	}
    ...
    var url = "" ;
    	url = "${pageContext.request.contextPath }/manualOrder/doPay" ;
        $.ajax({
            url : url,
            type: "POST",
...
<div class="money">
	<label for="money">订单号</label>
	<input type="text" class="input-money" id="customerRequestId" name="customerRequestId" autofocus placeholder="输入订单号">
</div>
<div class="money">
	<label for="money">金额</label>
	<input type="number" class="input-money" id="transAmt" name="transAmt" placeholder="输入金额"
