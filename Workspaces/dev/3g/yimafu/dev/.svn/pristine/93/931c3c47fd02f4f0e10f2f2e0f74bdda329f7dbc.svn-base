...
<div class="Container">
    <div class="Content fontText">
        ...
        <div style="margin: 0px auto;">
         <q:table queryService="ymfDownloadQueryService" doSum="true" queryKey="orderQueryCount" class="list" formId="form">
             <q:column title="交易笔数" value="${countno}" /> <q:column title="交易总金额" value="${sumamount}" />
         </q:table>
        </div>
        <div style="margin: 0px auto;">
            <div>
                <q:table queryService="ymfDownloadQueryService" queryKey="orderQuery" class="list" formId="form">
